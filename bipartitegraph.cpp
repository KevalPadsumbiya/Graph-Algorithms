...
//in bipartite graph every vertex(node) must lies in only one set and if there is edge between two nodes of different sets then there must be a edge joining them
